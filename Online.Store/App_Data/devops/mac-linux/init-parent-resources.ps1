...
$serviceBusExists =  Get-AzureRMServiceBusNamespace -ResourceGroup $resourceGroupName -NamespaceName $serviceBusNameSpace -ea 0
...
$query = Get-AzureRmResource -Name $searchEngineName -ResourceType "Microsoft.Search/searchServices" -ea 0
